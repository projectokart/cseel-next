...
<div className="container mx-auto px-4 py-8 max-w-3xl">
          ...
          {/* Back */}
          <Link href="/projects" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary mb-6 transition-colors">
          ...
          {project.experiments && (
            <div className="mb-6">
              ...
              <Link href={`/experiment/${project.experiments.id}`}
