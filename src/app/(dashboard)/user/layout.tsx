...
const navItems = [
  ...
  { label: "My Profile",    icon: User,            href: "/user/profile" },
  { label: "My Projects",   icon: FolderOpen,      href: "/user/projects" },
  { label: "My Selections", icon: BookmarkCheck,   href: "/user/selections" },
  { label: "Experiments",   icon: FlaskConical,    href: "/simulations" },
  { label: "Settings",      icon: Settings,        href: "/user/settings" },
];

export default function UserLayout({ children }: { children: React.ReactNode }) {
  const { signOut, user, roles, loading, rolesLoading } = useAuth();
  ...
  }, [loading, rolesLoading, user, router]);
