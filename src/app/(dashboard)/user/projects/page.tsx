          ...
          {projects.map((p) => {
            ...
            return (
              <div key={p.id} className="bg-card border border-border rounded-2xl overflow-hidden hover:shadow-md hover:border-primary/30 transition-all group flex flex-col">
                <Link href={`/my-project/${p.id}`} className="block">
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex items-center justify-between pt-3 border-t border-border">
                    ...
                    <div className="flex items-center gap-1">
                      <Link href={`/my-project/${p.id}`} className="px-3 py-1 rounded-lg text-xs font-semibold bg-primary/10 text-primary hover:bg-primary hover:text-white transition-all">Open</Link>
