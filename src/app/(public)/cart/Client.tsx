...
<PageTransition>
        <div className="container mx-auto px-4 py-8 max-w-3xl min-h-[60vh]">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Link href="/hands-on-experiments" className="text-primary hover:underline flex items-center gap-1 text-sm">
            ...
            <>
              {items.length === 0 ? (
                <div className="text-center py-20">
                  ...
                  <Link href="/hands-on-experiments"><Button>Browse Experiments</Button></Link>
                </div>
              ) : (
                <>
                  ...
                  {selectedExperiments.map(exp => (
                    <Card key={exp.id}>
                      <CardContent className="flex items-center gap-4 p-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <Link href={`/experiment/${exp.id}`} className="font-semibold text-sm text-foreground hover:text-primary transition-colors line-clamp-1">
                            {exp.title}
                          </Link>
