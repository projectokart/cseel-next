  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (user) {
        ...
        setLikedSet(liked as Set<string>);
      }
      setLoading(false);
    })();
  }, [id, user]);
...
<div className="max-w-2xl mx-auto px-4 py-20 text-center">
      ...
      <Link href="/channels"><Button>← All Channels</Button></Link>
    </div></>
  );
...
<PageTransition>
        <div className="max-w-2xl mx-auto px-4 py-8">
          <Link href="/channels" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-5 transition-colors">
