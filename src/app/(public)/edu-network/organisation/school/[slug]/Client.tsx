                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-between gap-3">
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 flex-wrap mt-2.5 text-[11px]">
                              <span className="px-2 py-0.5 bg-blue-50 text-blue-700 font-bold rounded-lg border border-blue-100 flex items-center gap-1 text-[10px]">
                                <Sparkles className="w-3 h-3 text-blue-600" />
                                <span>{org.stemLabsCount} STEM Labs</span>
                              </span>
                              {org.facilities.slice(0, 3).map((f, idx) => (
                                <span key={idx} className="px-2 py-0.5 bg-slate-100 text-slate-600 rounded-lg text-[10px]">
                                  {f}
                                </span>
                              ))}
                          ...
                          <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between gap-2 flex-wrap">
                            ...
                            {/* Utility Buttons (Compare, Shortlist, Share) */}
                            <div className="flex items-center gap-1.5 sm:gap-2">
                              ...
                              >
                                ...
                                <span className="text-[11px] sm:text-xs">{isCompared ? 'Added' : 'Compare'}</span>
                              </button>
                              ...
                              <button
                                ...
                                className="p-1.5 sm:p-2 rounded-xl border transition-all bg-slate-50 border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-200"
                                title="Share"
                              >
                            ...
                            <div className="flex items-center gap-1.5 sm:gap-2">
                              <button
                                ...
                                className="px-3 sm:px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs rounded-xl transition-all"
                              >
                                Enquiry
                              </button>
                              <Link
                                href={`/edu-network/org/${org.id}`}
                                className="px-3.5 sm:px-4 py-1.5 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold text-xs rounded-xl shadow-xs flex items-center gap-1 transition-all"
                              >
