...
export const metadata: Metadata = {
  title: 'Top Schools in India 2026-27 | Fees, CBSE/ICSE/IB Boards, STEM Labs | CSEEL',
  ...
  alternates: {
    canonical: 'https://www.cseel.org/edu-network/school',
  },
  openGraph: {
    title: 'Top Schools in India 2026-27 | Fees, CBSE/ICSE/IB Boards, STEM Labs | CSEEL',
    description: 'Explore 100+ top schools in India. Compare verified monthly fees, student-faculty ratios, board affiliations (CBSE, ICSE, IB), and live experiential STEM science laboratory infrastructure.',
    url: 'https://www.cseel.org/edu-network/school',
    siteName: 'CSEEL',
    locale: 'en_IN',
    type: 'website',
  },
...
export default function SchoolDirectoryMainPage() {
  return <EduNetworkClient initialTab="orgs" />;
}
