...
import { Eye, EyeOff, ArrowLeft, Loader2, CheckCircle2, FileSpreadsheet, GraduationCap, Building2, Sparkles, Check, Download, ShieldCheck } from "lucide-react";
...
import { ALL_PORTAL_CREDENTIALS, downloadPortalCredentialsCSVFile } from "@/lib/portalCredentialsData";
...
const Login = () => {
  ...
  useEffect(() => {
    if ((role === "student" || role === "teacher") && step === "details") {
      (supabase as any).from("organisations")
