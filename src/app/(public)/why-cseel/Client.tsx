...
const nodeData = {
  ...
  simulation:  { title:"Simulation",           subtitle:"Visualise the concept",     phase:"Phase 2 · Conceptualize", color:"#0F766E", light:"#CCFBF1", tag:"live lab · Simulation",          emoji:"🖥️", content:`Some experiments are too dangerous or impossible in a regular classroom.\n\nCSEEL's hands-on experiment platform lets students explore these safely. Students manipulate variables and run experiments hundreds of times in minutes.\n\nSimulations bridge the gap between what a classroom can offer and what science actually looks like.`, bullets:["100+ hands-on experiments & live labs","Safe exploration of dangerous experiments","Variable manipulation & observation","Unlimited repetition for mastery"] },
...
/* ─── FEATURES ─── */
const features = [
  { icon:Beaker,        title:"100+ live labs",  desc:"Access science experiments anytime, anywhere." },
...
<PageTransition>
      ...
      <section className="about-hero-gradient py-14 md:py-24 text-center text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/compare-plans"><Button size="lg" variant="secondary" className="rounded-full px-6">Explore Plans</Button></Link>
            <Link href="/demo"><Button size="lg" variant="outline" className="rounded-full px-6 border-white/30 text-white hover:bg-white/10">See Demo</Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 about-hero-gradient text-center text-primary-foreground">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/compare-plans"><Button size="lg" variant="secondary" className="rounded-full px-8">Get Started Free</Button></Link>
            <Link href="/contact-us"><Button size="lg" variant="outline" className="rounded-full px-8 border-white/30 text-white hover:bg-white/10">Talk to Us</Button></Link>
          </div>
        </div>
      </section>
