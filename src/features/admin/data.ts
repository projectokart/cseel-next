...
export const ADMIN_ROLE_CONFIGS: Record<AdminRole, AdminRoleConfig> = {
  ...
  school_admin: {
    ...
    badgeText: '🏫 School Directory Manager',
  ...
  recruitment_admin: {
    ...
    badgeText: '👨‍🏫 External Faculty & Jobs',
  ...
  science_admin: {
    ...
    badgeText: '🧪 Virtual Labs & Practicals',
  ...
  content_admin: {
    ...
    badgeText: '🌐 Content & Homepage CMS',
