...
export const ADMIN_ROLE_CONFIGS: Record<AdminRole, AdminRoleConfig> = {
  ...
  science_admin: {
    role: 'science_admin',
    title: 'live lab & Simulation Lead',
    department: 'Academic Science Team',
    color: 'cyan',
    badgeBg: 'bg-cyan-500/20 border-cyan-400/40 text-cyan-300',
    badgeText: 'live labs & Simulations',
    allowedModules: ['overview', 'science_simulations', 'audit_logs'],
    description: 'Configures interactive physics/chemistry/biology practical experiments, apparatus variables, and NEP-2020 lab practical manuals.',
  },
  projectokart_admin: {
...
export const INITIAL_ADMIN_USERS: AdminUser[] = [
  ...
  {
    id: 'adm-4',
    name: 'Faculty Recruitment Specialist',
    email: 'recruitment@123',
    password: 'Dev@12345',
  ...
  {
    id: 'adm-6',
    name: 'Projectokart Manager',
    email: 'projectokart@123',
    password: 'Dev@12345',
